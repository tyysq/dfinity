...
By default, Reveal is configured with [highlight.js](https://highlightjs.org/) for code syntax highlighting. To enable syntax highlighting, you'll have to load the highlight plugin \([plugin/highlight/highlight.js](https://github.com/tyysq/github-slideshow/tree/d64d18660190ae168abca68d747611affb4be584/node_modules/reveal.js/plugin/highlight/highlight.js)\) and a highlight.js CSS theme \(Reveal comes packaged with the Monokai themes: [lib/css/monokai.css](https://github.com/tyysq/github-slideshow/tree/d64d18660190ae168abca68d747611affb4be584/node_modules/reveal.js/lib/css/monokai.css)\).
...
Presentations can be exported to PDF via a special print stylesheet. This feature requires that you use [Google Chrome](http://google.com/chrome) or [Chromium](https://www.chromium.org/Home) and to be serving the presentation from a web server. Here's an example of an exported presentation that's been uploaded to SlideShare: [http://www.slideshare.net/hakimel/revealjs-300](http://www.slideshare.net/hakimel/revealjs-300).
